<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="FA_CallCenterAreaCliente.aspx.cs" Inherits="jycboliviaASP.net.Presentacion.FA_CallCenterAreaCliente" %>
...
<td>
    ...
    <td>
                        ...
                        <td>
                            <asp:TextBox ID="tx_Cliente" runat="server" Width="250px" Font-Size="X-Small"></asp:TextBox>
                            </td>
                        <td></td>
                        <td>
                        ...
                        <td>
                            <asp:TextBox ID="tx_edificio" runat="server" Width="250px" Font-Size="X-Small"></asp:TextBox>
                            </td>
                        <td></td>
                        <td>
...
" Font-Size="Small"></asp:Label>
                        ...
                        <td>
                            <asp:TextBox ID="tx_Direccion" runat="server" Width="250px" Font-Size="X-Small"></asp:TextBox>
                            </td>
                        <td></td>
                        <td></td>
                        <td>
                        ...
                        <td>
                            <asp:TextBox ID="tx_Ascensores" runat="server" Width="250px" 
                                Font-Size="X-Small"></asp:TextBox>
                            </td>
                        <td></td>
                        <td></td>
                        ...
                        <td></td>
                            ...
                            <td class="style10">
                                <asp:TextBox ID="tx_observacionTecnico"  TextMode = "MultiLine" runat="server" 
                                    Height="80px" Width="500px" Font-Size="X-Small"></asp:TextBox></td>
                            <td></td>
                            </tr>
                            ...
                            <td class="style8">
                                <asp:TextBox ID="tx_defectoConstatadoEvento" runat="server" Width="220px" 
                                    Enabled="False" Height="80px" style="margin-left: 0px" 
                            ...
                            <td></td>
                            <td>
                                <asp:Label ID="Label53" runat="server" Font-Size="Small" Text="Prioridad:"></asp:Label>
                                </td>
                            <td>
                            ...
                            <td></td>
                            <td>
                                <asp:CheckBox ID="cbx_recotizar" runat="server" Font-Size="Small" 
                                    Text="Re-cotizar" />
                                </td>
                            <td></td>
                            </tr>
                            ...
                            <td>
                                <asp:TextBox ID="tx_detalleContactoCliente" runat="server" Height="80px" 
                                    TextMode="MultiLine" Width="450px" Font-Size="X-Small"></asp:TextBox>
                                </td>
                            <td></td>
                            </tr>
