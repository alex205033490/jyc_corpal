<%@ Page Title="" Language="C#" MasterPageFile="~/PlantillaNew.Master" AutoEventWireup="true" CodeBehind="FCorpal_OrdenProduccion.aspx.cs" Inherits="jycboliviaASP.net.Presentacion.FCorpal_OrdenProduccion" %>
...
<div class="card">
  <div class="card-header bg-success text-white">Objetivo Orden Produccion</div>
  <ul class="list-group list-group-flush">
    ...
    <div class="col-md-12 col-md-offset-1">        
               ...
               <tr>        
                <td>
                    <asp:Label ID="Label46" runat="server" Text="Nro Produccion:"></asp:Label>
                   </td>                    
                <td>
               ...
               <table>
                <tr>
                <td>
                    <asp:Label ID="Label47" runat="server" Text="Fecha Produccion:"></asp:Label>
                    </td>
                <td>
                    <asp:TextBox ID="tx_fechaProduccion" class="form-control" runat="server"></asp:TextBox>
                    <asp:CalendarExtender ID="tx_fechaProduccion_CalendarExtender" runat="server" 
                        TargetControlID="tx_fechaProduccion">
                ...
                <tr>
                    <td><asp:Label ID="Label1" runat="server" Text="Cantidad Turno Mañana:"></asp:Label></td>
                    <td>
                        <asp:TextBox ID="tx_cantTurnoDia" CssClass="form-control" runat="server" BackColor="Yellow"></asp:TextBox></td>
                    <td><asp:Label ID="Label32" runat="server" Text="Medida:"></asp:Label></td>
                    <td><asp:TextBox ID="tx_medida" class="form-control" runat="server" Width="150px"></asp:TextBox></td>
                </tr>
                <tr>
                    <td><asp:Label ID="Label2" runat="server" Text="Cantidad Turno Tarde:"></asp:Label></td>
                    <td>
                        <asp:TextBox ID="tx_cantTurnoTarde" CssClass="form-control" runat="server" BackColor="Yellow"></asp:TextBox></td>
                    <td></td>
                    <td></td>
                </tr>
                <tr>
                    <td><asp:Label ID="Label3" runat="server" Text="Cantidad Turno Noche:"></asp:Label></td>
                    <td>
                        <asp:TextBox ID="tx_cantTurnoNoche" CssClass="form-control" runat="server" BackColor="Yellow"></asp:TextBox></td>
                    <td></td>
                    <td></td>
                </tr>
            ...
            <div class="row">
                <div class="col-md-12 col-md-offset-1">        
                        <div class="DatosProyecto">
                            <asp:GridView ID="gv_OrdendeProduccion" 
