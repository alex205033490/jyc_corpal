<%@ Page Title="" Language="C#" MasterPageFile="~/PlantillaNew.Master" AutoEventWireup="true" CodeBehind="FUpon_CargaCompras.aspx.cs" Inherits="jycboliviaASP.net.Presentacion.FA_CargarDocumentos" %>
...
<div class="col-md-12 offset-1" >
    ...
    <li class="list-group-item">
        <div class="row">
            <div class="col-md-12">
                <div class="edificios">
    <asp:GridView ID="gv_comprasCargadas" runat="server" BackColor="#CCCCCC"
