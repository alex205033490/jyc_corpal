<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="FA_AgendaProyectos.aspx.cs" Inherits="jycboliviaASP.net.Presentacion.FA_AgendaProyectos" EnableEventValidation = "false" %>
<%@ Register TagPrefix="inmoInfo" TagName="menu" Src="ControlUser.ascx" %>
<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
<link href="../Styles/Style_AgendaProyecto.css" rel="stylesheet" type="text/css" />
...
<div class="DatosProyecto">
    ...
    <table>
        ...
        <td>
                <asp:TextBox ID="tx_Proyeto_Busqueda" runat="server" Width="250px" 
                    Font-Size="X-Small"></asp:TextBox>
                <asp:AutoCompleteExtender ID="tx_Proyeto_Busqueda_AutoCompleteExtender" runat="server" 
                    TargetControlID="tx_Proyeto_Busqueda"
        ...
        <td>
                <asp:Button ID="Button1" runat="server" onclick="Button1_Click" 
                    Text="Buscar Proyecto" Width="120px" />
            </td>
        </tr>
        ...
        <td>
            <asp:Button ID="bt_agendaAsignacion" runat="server" Text="Buscar Agenda" 
                onclick="bt_agendaAsignacion_Click" Width="120px" />
            </td>
        </tr>
...
<div class="Cliente">
        ...
        <td>
            ...
            <asp:AutoCompleteExtender ID="tx_edificioAgenda_AutoCompleteExtender" 
                runat="server" TargetControlID="tx_edificioAgenda"                 
                CompletionSetCount="12" 
        ...
        <td>
            ...
            <asp:AutoCompleteExtender ID="tx_responsableAsignado_AutoCompleteExtender" 
