        ...
        <div class="row">
            <div class="col-md-11 col-md-offset-1">
                <div class="panel panel-success class">
                    ...
                    <div class="form_getInvIngreso p-4 bg-light border rounded">
                        <h2 class="text-tittle2">Detalles de Inventario Ingresos</h2>
                        ...
                        <div class="container_input row mb-4">
                            ...
                            <div class="container_btn col-sm-4 col-md-6 col-lg-6 d-flex align-items-end">
                                <asp:Button ID="btn_InvIngresoGET" runat="server" Text="Buscar registro" CssClass="btn btn-warning" OnClick="btn_InvIngresoGET_Click" />
                            </div>
                        </div>
