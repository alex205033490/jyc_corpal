            ...
            <div class="col-md-12 col-md-offset-1">
                <div class="panel panel-success class">
                    ...
                    <div class="container-POSTPersona p-4 rounded col-lg-12">
                        ...
                        <asp:UpdatePanel ID="updatePanelPost_Client" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                    ...
                    <div class="container-POSTEmpresa p-4 rounded col-lg-12">
                        ...
                        <!-- formulario -->
                        <asp:UpdatePanel ID="updatePanelPostEmpresa" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                    ...
                    <div class="container-VaciadoClientes p-4 rounded col-lg-12">
                        ...
                        <asp:UpdatePanel ID="updatePanelGETClientEmpresa" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                            ...
                            <Triggers>
                                <asp:AsyncPostBackTrigger ControlID="btn_buscarCliente" EventName="Click" />
                            </Triggers>
                        </asp:UpdatePanel>
                    </div>
                    <br />
