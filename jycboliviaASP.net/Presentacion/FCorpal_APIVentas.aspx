                        ...
                        <asp:Panel runat="server" DefaultButton="btn_getVentas">
                            <div class="container_input row mb-1">
                                ...
                                <div class="container_btn col-3 col-sm-2 col-md-2 col-lg-1 d-flex align-items-end">
                                    <asp:Button ID="btn_getVentas" runat="server" Text="Buscar" CssClass="btn btn-dark btn-sm" title="Ingrese un código o deje vacío para mostrar todos los registros" OnClick="btn_getVentas_Click" />
                                </div>
                            </div>
                        </asp:Panel>

                        <asp:UpdatePanel ID="updatePanel_GETVentas" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                            ...
                            <Triggers>
                                <asp:AsyncPostBackTrigger ControlID="btn_getVentas" EventName="Click" />
                            </Triggers>
                        </asp:UpdatePanel>
                    </div>
                    <br />
