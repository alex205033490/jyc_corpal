...
namespace jycboliviaASP.net.Negocio
{
    public class NA_VariablesGlobales
    {
       ...
       // public static List<string> listNombreBaseDatos = new List<string> { "Santa Cruz", "Cochabamba", "La Paz", "Prueba" };
        ...
        public static string fechaInicialProduccion = "'2025-11-08'";
        public static string fechaInicialentregaProducto = "'2025-11-08'";
        ...
        internal string get_consultaStockProductosActual() {
            ...
            string consultaStock = "SELECT pp.codigo, pp.producto, pp.medida, " +
                "ifnull(t1.ingreso,0) as 'Ingreso1', ifnull(t2.salida,0) as 'Salida1',   " +
