...
namespace jycboliviaASP.net.Presentacion
{
    public partial class FA_ReciboEgreso : System.Web.UI.Page
    {
        ...
        private void insertarDAtos()
        {
            ...
            bool bandera = nrr.insertarReciboEgreso(pagadoha, monto, moneda, chequenro, concepto, detalle, codrespgra, responsable, banco, efectivo, porcentajeretencioniue, porcentajeretencionit, retencioniuebs, retencionitbs, totalapagar, facturanro, nroRecibo);
            if (bandera)
            {
                limpiarDatos();
                buscarDatos("", codUser);
        ...
        private void modificarDatos()
        {
            if (gv_reciboIngresoEgreso.SelectedIndex > -1)
            {
                ...
                NA_Recibo_IngresoEgreso nrr = new NA_Recibo_IngresoEgreso();
                bool bandera = nrr.modificarReciboEgreso(codigo, pagadoha, monto, moneda, chequenro, concepto, detalle, codrespgra, responsable, banco, efectivo, porcentajeretencioniue, porcentajeretencionit, retencioniuebs, retencionitbs, totalapagar, facturanro);
                if (bandera)
                {
                    limpiarDatos();
                    buscarDatos("", codUser);                    
