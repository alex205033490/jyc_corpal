...
{
    public partial class FA_GestionArchivosJYC : System.Web.UI.Page
    {
        private string rutaArchivo = ConfigurationManager.AppSettings["RutaJYC"];             
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (tienePermisoDeIngreso(39) == false)
            {
        ...
        public void buscarArchivo(string rutaArchivo, string Archivo)
        {
            ...
            dt.Columns.AddRange(new DataColumn[3] { new DataColumn("Archivo", typeof(string)), new DataColumn("Ruta", typeof(string)), new DataColumn("Fecha Modificacion", typeof(string)) });
