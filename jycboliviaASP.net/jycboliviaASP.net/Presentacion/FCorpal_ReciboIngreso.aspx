<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="FCorpal_ReciboIngreso.aspx.cs" Inherits="jycboliviaASP.net.Presentacion.FA_ReciboIngreso" %>
...
<div class="row">
    <div class="col-md-10 col-md-offset-1">
        <div class="panel panel-success class">
            ...
            <h3 class="panel-title">COMPROBANTE DE INGRESO:</h3>
            </div>
       ...
       <tr>
        <td>
            <asp:Label ID="Label36" runat="server" Text="Nro Recibo :"></asp:Label>
           </td>
        <td>
            <asp:TextBox ID="tx_nroRecibo" class="form-control" runat="server" 
       ...
       <td></td>       
        ...
        <td>
            <asp:TextBox ID="tx_cliente" class="form-control" runat="server" 
    ...
    <table>
        ...
        <tr>
            <td>
                <asp:Label ID="Label1" runat="server" Text="Factura Nro. :"></asp:Label>
            </td>
            <td>
                <asp:TextBox ID="tx_nroFactura" class="form-control" runat="server" 
                    Width="300px"></asp:TextBox>
            </td>
            <td></td>            
        </tr>
    ...
    <table>
        <tr>
            ...
            <td>
                <asp:TextBox ID="tx_concepto" class="form-control" runat="server" Width="350px"></asp:TextBox>
            </td>
            <td></td>            
        </tr>    
    </table>
