<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="FA_GestionArchivosJYC.aspx.cs" Inherits="jycboliviaASP.net.Presentacion.FA_GestionArchivosJYC" %>
...
<div class="GA" >
 ...
 <td>
 <div class="GA_titulo">
     <asp:Label ID="lb_titulo" runat="server" Text="Documentos de JyC" 
 ...
 <td>
     <asp:Button ID="bt_mostrarArbol" runat="server" onclick="Button1_Click" 
