<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="FA_CallCenter_EventoNuevo.aspx.cs" Inherits="jycboliviaASP.net.Presentacion.FA_CallCenter" %>
  ...
  <td>
     <table>
                 ...
                 <td>
                                    ...
                                    <td></td>
                                    <td>
                                        <asp:Label ID="Label15" runat="server" Text="Base de Datos :"></asp:Label>
                                        </td>
                                    <td></td>
                                    <td>
                                        <asp:DropDownList ID="dd_departamento" runat="server" 
                                            onselectedindexchanged="dd_departamento_SelectedIndexChanged" 
                                            AutoPostBack="True" style="margin-left: 0px" Width="150px"  >
                                    ...
                                    <td>
                                        <asp:DropDownList ID="dd_tipoEvento" runat="server" Height="20px" Width="150px" 
                                            AutoPostBack="True" 
                                            onselectedindexchanged="dd_tipoEvento_SelectedIndexChanged" >
                                        </asp:DropDownList>
                                    </td>
                                    <td></td>
                                    </tr>
                                ...
                                <td></td>
                                <td>
                                    <asp:Label ID="Label4" runat="server" Text="Edificio:" Font-Size="X-Small"></asp:Label></td>
                                <td>
                                    <asp:TextBox ID="tx_Edificio" runat="server" Width="250px" 
                                        ontextchanged="tx_Edificio_TextChanged" Font-Size="Small"></asp:TextBox>
                                ...
                                <td></td>
                                <td class="style6">
                                    <asp:Label ID="lb_horacioAtencion" runat="server" Font-Size="X-Small"></asp:Label>
                                    </td>
                                <td class="style8">
                                    <asp:Label ID="lb_notienePrevision" runat="server" Font-Size="X-Small"></asp:Label>
                                    </td>
                                <td></td>
                                </tr>
                                ...
                                <td></td>
                                <td>
                                    <asp:Label ID="Label7" runat="server" Text="Cliente:" Font-Size="X-Small"></asp:Label>
                                    </td>
                                <td>
                                    <asp:TextBox ID="tx_nombreCliente" runat="server" Width="250px" 
                                        Font-Size="Small"></asp:TextBox>
                                    </td>
                                <td></td>
                                <td class="style6">
                                    <asp:Label ID="lb_verificar2" runat="server" Font-Size="X-Small"></asp:Label>
                                    </td>
                                <td class="style8">
                                    <asp:Label ID="lb_atencionMantenimiento" runat="server" Font-Size="X-Small"></asp:Label>
                                    </td>
                                <td></td>
                                </tr>
                                ...
                                <td></td>
                                <td>
                                    <asp:Label ID="Label13" runat="server" Font-Size="X-Small" Text="Celular:"></asp:Label>
                                    </td>
                                <td>
                                    <asp:TextBox ID="tx_celular" runat="server" Width="250px" Font-Size="Small"></asp:TextBox>
                                    </td>
                                <td></td>
                                <td class="style6">
                                    <asp:Label ID="lb_verificar" runat="server" Font-Size="X-Small"></asp:Label>
                                    </td>
                                <td class="style8">
                                    &nbsp;</td>
                                <td>
                                ...
                                <td></td>
                                <td>
                                    <asp:Label ID="Label14" runat="server" Font-Size="X-Small" Text="Telefono:"></asp:Label>
                                    </td>
                                <td>
                                    <asp:TextBox ID="tx_telefono" runat="server" Width="250px" Font-Size="Small"></asp:TextBox>
                                    </td>
                                <td></td>
                                <td class="style6">
                                    <asp:Label ID="lb_repuesto" runat="server" Font-Size="X-Small"></asp:Label>
                                    </td>
                                <td class="style8"></td>
                                <td></td>
                                </tr>
                                ...
                                <td></td>
                                <td>
                                    <asp:Label ID="Label6" runat="server" Text="Ascensor:" Font-Size="X-Small"></asp:Label>
                                    </td>
                                <td>
                                    <asp:TextBox ID="tx_ascensores" runat="server" Width="250px" ReadOnly="True" 
                                        Font-Size="Small"></asp:TextBox>
                                    </td>
                                <td></td>
                                <td class="style6">
                                    <asp:Label ID="lb_planPago" runat="server" Font-Size="X-Small"></asp:Label>
                                    </td>
                                <td class="style8"></td>
                                <td></td>
                                </tr>
                                ...
                                <td></td>
                                <td class="style6">
                                    <asp:Label ID="lb_cotizacionRepuesto" runat="server" Font-Size="X-Small"></asp:Label>
                                    </td>
                                <td class="style8">
                                    <asp:Label ID="lb_CantDiasDesdeLaAprobacionCotizacion" runat="server" 
                                        Font-Size="X-Small"></asp:Label>
                                    </td>
                                <td></td>
                                </tr>
                                ...
                                <td></td>
                                <td class="style6">
                                    <asp:Label ID="lb_paradoCliente" runat="server" Font-Size="X-Small"></asp:Label>
                                    </td>
                                <td class="style8"></td>
                                <td></td>
                                </tr>
                                ...
                                <td></td>
                                <td>
                                    <asp:CheckBox ID="cbx_cotizacionRepuesto" runat="server" Font-Size="Small" 
                                        Text="Cotizacion Repuesto"  AutoPostBack="True" 
                                        oncheckedchanged="cbx_cotizacionRepuesto_CheckedChanged"/>
                                    </td>
                                <td></td>
                                <td class="style6">
                                    <asp:Label ID="lb_paradoNosotros" runat="server" Font-Size="X-Small"></asp:Label>
                                    </td>
                                <td class="style8"></td>
                                <td></td>
                                </tr>
                                ...
                                <td></td>
                                <td class="style6">
                                    <asp:Label ID="lb_serviciosuspendido" runat="server" Font-Size="X-Small"></asp:Label>
                                    </td>
                                <td class="style8"></td>
                                <td></td>
                                ...
                                <td class="style7">
                                    ...
                                    <td></td>
                                <td>
                                    <asp:TextBox ID="tx_observacion"  TextMode = "MultiLine" runat="server" Height="66px" 
                                        Width="320px" Font-Size="Small"></asp:TextBox></td>
                                <td></td>
                                <td></td>
                                </tr>
                                </table> 
