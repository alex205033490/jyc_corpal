<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="FA_CallCenter_Eventos.aspx.cs" Inherits="jycboliviaASP.net.Presentacion.FA_CallCenter_Eventos" %>
...
<td>
    ...
    <td>
                            ...
                            <td class="style4">
                                <asp:TextBox ID="tx_BaseDeDatos" runat="server"></asp:TextBox>
                                </td>
                            <td>
                                <asp:Label ID="Label12" runat="server" Text="Edificio :" Font-Size="Small"></asp:Label></td>
                            <td>
                                <asp:TextBox ID="tx_nombreEdificioBusqueda" runat="server" Width="200px"></asp:TextBox></td>
                            ...
                            <td></td>
                            <td>
                                <asp:TextBox ID="tx_SemanaBusqueda" runat="server"></asp:TextBox>
                                </td>
                            <td>
                            ...
                            <td></td>
                            <td>
                                <asp:TextBox ID="tx_desdeBusqueda" runat="server"></asp:TextBox>
                            ...
                            <td>
                                <asp:TextBox ID="tx_hastaBusqueda" runat="server"></asp:TextBox>
                            ...
                            onclick="lk_excelEventos_Click" Font-Size="X-Small">Excel Eventos</asp:LinkButton>
                                ...
                                <td></td>
                                <td>
                                <asp:LinkButton ID="lk_reporteEvento" runat="server" Font-Size="X-Small" 
                                        onclick="lk_reporteEvento_Click">Excel Reporte Evento</asp:LinkButton>
                                </td>
                                <td></td>
                                <td></td>
                                <td></td>
                            ...
                            <td >
                                <asp:TextBox ID="tx_Regional" runat="server" Width="150px" Font-Size="X-Small"></asp:TextBox>
                                </td>
                            <td class="style5" ></td>
                            <td>
                                <asp:Label ID="Label5" runat="server" Text="LLamada :" Font-Size="Small"></asp:Label></td>
                            <td>
                                <asp:TextBox ID="tx_tipoEvento" runat="server" Font-Size="X-Small" 
                            ...
                            <td>
                                <asp:TextBox ID="tx_fechaEvento" runat="server" Width="150px" 
                            ...
                            <td>
                                <asp:TextBox ID="tx_horaEvento" runat="server" Width="150px" 
                                    Font-Size="X-Small"></asp:TextBox>
                                </td>
                            <td></td>
                            </tr>
                        ...
                        <td>
                            <asp:TextBox ID="tx_Cliente" runat="server" Width="200px" Font-Size="X-Small"></asp:TextBox>
                            </td>
                        <td></td>
                        <td>
                        ...
                        <td>
                            <asp:TextBox ID="tx_telefono" runat="server" Width="200px" Font-Size="X-Small"></asp:TextBox>
                            </td>
                        <td></td>
                        </tr>
                        ...
                        <td>
                            <asp:TextBox ID="tx_edificio" runat="server" Width="200px" Font-Size="X-Small"></asp:TextBox>
                            </td>
                        <td></td>
                        <td>
                        ...
                        <td>
                            <asp:TextBox ID="tx_celular" runat="server" Width="200px" Font-Size="X-Small"></asp:TextBox>
                            </td>
                        <td></td>
                        </tr>
                        ...
                        <td>
                            <asp:TextBox ID="tx_Direccion" runat="server" Width="200px" Font-Size="X-Small"></asp:TextBox>
                            </td>
                        <td></td>
                        <td></td>
                        <td>
                        ...
                        <td>
                            <asp:TextBox ID="tx_observacion"  TextMode = "MultiLine" runat="server" Height="80px" 
                                Width="450px" Font-Size="X-Small"></asp:TextBox></td>
                        <td></td>
                        </tr>
                        </table> 
                            ...
                            <td></td>
                            <td>
                                <asp:TextBox ID="tx_fechaSupervisorAsignado" runat="server" Font-Size="X-Small" 
                            ...
                            <td>
                                ...
                                <td>
                                    <asp:TextBox ID="tx_horaSupervisorAsignado" runat="server" Font-Size="X-Small" 
                                        Width="120px"></asp:TextBox>
                                </td>
                                <td></td>
                            </tr>
                            ...
                            <td class="style11">
                                <asp:TextBox ID="tx_HoraTecnicoAsignacion" runat="server" Width="150px"></asp:TextBox>
                                </td>
                            <td>
                            ...
                            <td>
                                <asp:TextBox ID="tx_FechaTecnicoAsignacion" runat="server" Width="150px"></asp:TextBox>
                            ...
                            <td>
                                <asp:TextBox ID="tx_horaReporte" runat="server" Width="150px"></asp:TextBox>
                                </td>
                            <td>
                                <asp:Label ID="Label50" runat="server" Font-Size="Small" Text="Fecha Reporte :"></asp:Label>
                                </td>
                            <td>
                                <asp:TextBox ID="tx_fechaReporte" runat="server" Width="150px"></asp:TextBox>
                            ...
                            <td class="style11">
                                <asp:TextBox ID="tx_horallegadaAlEdificioTecnico" runat="server" Width="150px"></asp:TextBox>
                                </td>
                            <td>
                            ...
                            <td>
                                <asp:TextBox ID="tx_fechahorallegada" runat="server" Width="150px"></asp:TextBox>
                            ...
                            <td class="style9">
                                <asp:Label ID="Label14" runat="server" Text="Hora Salida del Edificio :" 
                                    Font-Size="Small"></asp:Label></td>
                            <td class="style11">
                                <asp:TextBox ID="tx_horaSalidadelEdificioTecnico" runat="server" Width="150px"></asp:TextBox></td>
                            <td>
                                ...
                                <asp:TextBox ID="tx_fechahorasalida" runat="server" Width="150px"></asp:TextBox>
                            ...
                            <td>
                                ...
                                <td>
                                <asp:TextBox ID="tx_ascensorReparado" runat="server" Width="150px"></asp:TextBox>
                                </td>
                            </tr>
                            ...
                            <td class="style10">
                                <asp:TextBox ID="tx_observacionTecnico"  TextMode = "MultiLine" runat="server" 
                                    Height="70px" Width="400px" Font-Size="X-Small"></asp:TextBox></td>
                            <td></td>
                            </tr>
                            ...
                            <td></td>
                            <td class="style13">
                                <asp:Label ID="Label17" runat="server" Text="Detalle Cierre Evento:" 
                                    Font-Size="Small"></asp:Label>
                                </td>
                            <td>
                                <asp:TextBox ID="tx_observacionEvento" runat="server" Height="84px" 
                                    TextMode="MultiLine" Width="500px" Font-Size="X-Small"></asp:TextBox>
                                </td>
                            <td></td>
                            ...
                            <td></td>
                            <td class="style13">
                                <asp:Label ID="Label24" runat="server" Text="Estado Evento:" Font-Size="Small"></asp:Label>
                                </td>
                            <td>
                                <asp:DropDownList ID="dd_estadoEvento" runat="server" Height="25px" 
                                    Width="120px">
                                    <asp:ListItem>Abierto</asp:ListItem>
                                    <asp:ListItem>Cerrado</asp:ListItem>
                                </asp:DropDownList>
                            ...
                            <td class="style13"></td>
                            <td>
                                <asp:CheckBox ID="ckb_envioRcc" runat="server" Font-Size="Small" 
                                    Text="Envio RCC" />
                                </td>
                            <td></td>
                            </tr>
