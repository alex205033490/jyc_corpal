  ...
  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
   <ul class="nav navbar-nav">	     
    ...
    Productos 	</a>
        ...
        <li><a href="../Presentacion/FCorpal_AprobacionDevolucionProductoTerminado.aspx" id="mn_AprobaciondevolucionProductoTerminado" runat="server"><span>Aprobacion Devolucion Productos</span></a></li>                                                 
