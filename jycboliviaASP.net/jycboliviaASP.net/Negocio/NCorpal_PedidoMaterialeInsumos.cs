...
{
    public class NCorpal_PedidoMaterialeInsumos
    {
        DCorpal_PedidoMaterialeInsumos dpedido = new DCorpal_PedidoMaterialeInsumos();
        public NCorpal_PedidoMaterialeInsumos() { }
        ...
        {
            return dpedido.get_DatosSolicitudMaterialeInsumos( codigoSMI);
        }

        internal DataSet get_DatosSolicitudMaterialeInsumos_item(int codigoSMI)
        {
            return dpedido.get_DatosSolicitudMaterialeInsumos_item(codigoSMI);
        }
    }
}