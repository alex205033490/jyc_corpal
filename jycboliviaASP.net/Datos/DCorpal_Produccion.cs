    ...
    public class DCorpal_Produccion
    {
        ...
        internal decimal get_obtenerUnidadContenidoProducto(string item)
        {
            try
            {
                ...
                cmd.Parameters.AddWithValue("@producto", item);

                object resultado = Conx.ejecutarScalarObject(cmd);
            ...
            {
                throw new Exception("Error al obtener Unidad Contenido. " + ex.Message);
            }
        }
